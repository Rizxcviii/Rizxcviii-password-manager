...
const createHTMLNotification = ({ useCase, password }) =>
  `
    ...
    <div style="z-index: 69420 ;width: 300px; position: fixed;top: 16px;right: 16px;border: 1px solid #DEF2F1;border-radius: 8px;padding: 16px;font-family: 'Centra';background-color: azure;" id="add-password-rizxcviii">
